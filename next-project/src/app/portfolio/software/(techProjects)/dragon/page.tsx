    ...
    <div style={{ marginBottom: "100px" }}>
      ...
      <div className={styles.animExpand}>
        ...
        <p className={styles.paragraph}>
          ...
          personal undertaking purely for learning and enjoyment. I built it
          using basic JavaScript and CSS, without any frameworks. It was done
          during the second module of my course, and I dedicated many late
          nights and weekends to its development. During this time, my passion
          for coding was intense, and I was constantly thinking about how to add
          new features and fix any bugs.I gained valuable knowledge and skills
          in JavaScript during the development process, establishing a solid
          foundation in its core concepts. I wasn't overly concerned about the
          visual style, so there may be a few errors on the page. The primary
          focus was to maximize my learning experience with JavaScript.
          Additionally, because I intended to showcase this project during the
          course, I had limited time available for its development.
        </p>
      </div>
      ...
      <div className={styles.containerTextandImg}>
        ...
        <div className={styles.animSlideRight}>
          <p className={styles.paragraph}>
            ...
            something i havent yet learned on that period. Instead, I
            implemented authentication using an array of users that contains
            their information. The login functionality verifies whether the
            entered username and password match any of the records in the array.
            If there is a match, the login is successful. Otherwise, an error
            message is displayed, indicating whether the user exists or if the
            password is incorrect. To create a new user, the system requires the
            user to enter their desired password twice. The passwords must match
            for the user to be successfully created. If the passwords match, a
            new user is added to the array of users with their provided
            credentials, along with the default package assigned to all new
            users.
          </p>
        </div>
      </div>
      ...
      <div className={styles.containerColumn}>
        ...
        <div className={styles.animSlideLeft}>
          <p className={styles.paragraph}>
            The Home page serves as a central hub, providing seamless access to
            a range of features and functionalities. Utilizing dynamic routing
            ...
            various sections. Additionally, users have the flexibility to
            utilize or sell potions and materials, enhancing their gameplay
            experience.
          </p>
        </div>
      </div>
      ...
      <div className={styles.containerColumn}>
        <div className={styles.animSlideRight}>
          <p>
            The Item Shop page offers a comprehensive list of potions available
            in the game. Each potion can be purchased using diamonds or crafted
            if the necessary materials are available. If materials are lacking,
            a prompt will inform the player about the missing components. On the
            ...
            diamonds for purchase using gold coins. Similar to potion
            acquisition, the logic ensures that players can only buy diamonds if
            they possess enough gold coins to cover the cost.
          </p>
        </div>
        <div className={styles.animSlideLeft}>
      ...
      <div className={styles.containerColumn}>
        ...
        <div className={styles.animSlideLeft}>
          <p className={styles.paragraph}>
            ...
            encounter unique monsters. The materials available for collection
            vary in each section, adding diversity to the gameplay. Furthermore,
            the monsters encountered during exploration dynamically adapt based
            on the life stage of the player's dragon, adding an element of
            challenge and excitement to the adventure.
          </p>
        </div>
        <div className={styles.containerRow}>
          <Image
      ...
      <div className={styles.containerRow}>
        ...
        <div className={styles.animSlideRight}>
          <p style={{ flex: "1" }} className={styles.paragraph}>
            ...
            principles govern the enemy's attacks. Engaging sound effects
            enhance the interactive nature of the gameplay. Victorious battles
            yield experience points (XP), while defeat results in XP deduction.
            To continue exploring, you must consume a healing potion to restore
            your health.
          </p>
        </div>
      </div>
...
"
    ...
    "
      ...
      <div className={styles.containerColumn}>
        <div className={styles.animSlideRight}>
          <p className={styles.paragraph}>
            In the trade market, players have the opportunity to exchange
            potions and materials with other users. You can create a trade post,
            specifying the items you wish to trade and what you're seeking in
            return. Alternatively, you can browse existing trade posts to see
            what other players are offering. If you possess the desired items,
            you can accept the trade. Implementing this functionality without a
            backend was a challenging and enjoyable task. On the example below,
            user Bruno did a post, later on another user accepted that trade.
          </p>
        </div>
        <div className={styles.animSlideLeft}>
          <div className={styles.containerRow}>
...
"
      ...
      <div className={styles.animSlideRight}>
        <p className={styles.paragraph}>
          This is a comprehensive and intricate application with numerous
          details that I haven't covered in this brief overview. If you're
          interested in exploring the code, feel free to check out the GitHub
          repository:{" "}
        </p>
        <p className={styles.paragraph}>
          {" "}
      ...
      <div className={styles.animSlideLeft}>
        ...
        <p className={styles.paragraph}>
          ...
          Password: tina. Alternatively, you can create a new user and begin
          your journey from scratch. Please keep in mind that this project is
          not a full-stack application, which means that the information is not
          stored in a database. As long as you avoid refreshing the page,
          everything should function smoothly. Enjoy your experience!
        </p>
      </div>
    </div>
  );

    ...
    <div style={{ marginBottom: "100px" }}>
      ...
      <div className={styles.containerTextogImgRevert}>
        ...
        <p style={{ alignSelf: "center" }} className={styles.paragraph}>
          Although I had some prior experience with drysuits, it was in Lofoten,
          with daily dives, teaching sessions, discover scuba dives, and
          guiding, that I honed my skills and expertise. Upon returning to
          ...
          courses, full of students, from a big variety of ages and background.
          In the colder months, The diving stays present, but just as a hobby.
        </p>
      </div>

      <div className={styles.containerTextogImg}>
        <p style={{ alignSelf: "center" }} className={styles.paragraph}>
          Diving in Norway presents unique challenges, as the water here is the
          coldest I have ever encountered. This has provided me with invaluable
          experience in handling different equipment requirements and
          procedures. Every day, I strive to deepen my knowledge in both diving
          and teaching, and I am grateful for the opportunity to remain active
          as a dive instructor. Moreover, I am proud to serve as a board member
          in the Stavern Dive Club, where we continually evolve, grow, and

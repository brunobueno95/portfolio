    ...
    <div>
      ...
      <div style={{ marginBottom: "100px" }}>
        ...
        <p className={styles.paragraph}>
          ...
          passion for continuous learning and a background as a dive instructor.
          With a solid foundation in front-end development and a growing
          knowledge of back-end and software architecture, I bring a unique
          perspective to every project. I thrive in dynamic environments, enjoy
          collaborating with diverse teams, and strive to deliver high-quality
          solutions.
        </p>
